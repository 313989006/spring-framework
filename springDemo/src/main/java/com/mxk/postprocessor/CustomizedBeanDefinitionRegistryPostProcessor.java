...
/**
 * @ClassName 自定义 CustomizedBeanDefinitionRegistryPostProcessor，容器的后置处理器
 * @Description 实现 BeanDefinitionRegistryPostProcessor 接口，向容器注册额外的 BeanDefinition 实例
 * @Author ma.kangkang
 * @Date 2020/11/10 16:22
 **/
// CustomizedBeanDefinitionRegistryPostProcessor 也需要成为 Bean 才能和容器对话，给容器管理起来，所以需要加上 @Configuration 标签，或者 @Bean标签
@Configuration
