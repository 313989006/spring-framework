 ...
 * See test configuration files websocket-com.mxk.config-handlers-*.xml.
 *
 * @author Brian Clozel
...
public class HandlersBeanDefinitionParserTests {
	...
	public void webSocketHandlers() {
		loadBeanDefinitions("websocket-com.mxk.config-handlers.xml");
	...
	public void webSocketHandlersAttributes() {
		loadBeanDefinitions("websocket-com.mxk.config-handlers-attributes.xml");
	...
	@Test
	public void sockJs() {
		loadBeanDefinitions("websocket-com.mxk.config-handlers-sockjs.xml");
	...
	public void sockJsAttributes() {
		loadBeanDefinitions("websocket-com.mxk.config-handlers-sockjs-attributes.xml");
