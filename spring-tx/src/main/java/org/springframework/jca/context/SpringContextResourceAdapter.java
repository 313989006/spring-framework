 ...
 *		 &lt;com.mxk.config-property&gt;
 *			 &lt;com.mxk.config-property-name&gt;ContextConfigLocation&lt;/com.mxk.config-property-name&gt;
 *			 &lt;com.mxk.config-property-type&gt;java.lang.String&lt;/com.mxk.config-property-type&gt;
 *			 &lt;com.mxk.config-property-value&gt;META-INF/applicationContext.xml&lt;/com.mxk.config-property-value&gt;
 *		 &lt;/com.mxk.config-property&gt;
 *	 &lt;/resourceadapter&gt;
 * &lt;/connector&gt;</pre>
 *
 * Note that "META-INF/applicationContext.xml" is the default context com.mxk.config
 * location, so it doesn't have to specified unless you intend to specify
 * different/additional com.mxk.config files. So in the default case, you may remove
 * the entire {@code com.mxk.config-property} section above.
 *
...
public class SpringContextResourceAdapter implements ResourceAdapter {
	 ...
	 * multiple context com.mxk.config paths in a single String value.
	 * @see #setContextConfigLocation
	 */
	 ...
	 * <p>This can be specified as "ContextConfigLocation" com.mxk.config
	...
	protected ConfigurableApplicationContext createApplicationContext(BootstrapContext bootstrapContext) {
		...
		// Extract individual com.mxk.config locations.
	 ...
	 * @param configLocations the parsed com.mxk.config locations
	 * @see #setContextConfigLocation
	 */
