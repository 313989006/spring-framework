...
public abstract class TransactionManagementConfigUtils {
	...
	public static final String TRANSACTION_ADVISOR_BEAN_NAME =
			"org.springframework.transaction.com.mxk.config.internalTransactionAdvisor";

	/**
	 * The bean name of the internally managed transaction aspect (used when mode == ASPECTJ).
	 */
	public static final String TRANSACTION_ASPECT_BEAN_NAME =
			"org.springframework.transaction.com.mxk.config.internalTransactionAspect";
	...
	public static final String JTA_TRANSACTION_ASPECT_BEAN_NAME =
			"org.springframework.transaction.com.mxk.config.internalJtaTransactionAspect";
	...
	public static final String TRANSACTIONAL_EVENT_LISTENER_FACTORY_BEAN_NAME =
			"org.springframework.transaction.com.mxk.config.internalTransactionalEventListenerFactory";
