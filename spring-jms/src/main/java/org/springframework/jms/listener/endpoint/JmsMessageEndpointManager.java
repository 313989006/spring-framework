...
public class JmsMessageEndpointManager extends GenericMessageEndpointManager
	 ...
	 * <p>This com.mxk.config object will be turned into a concrete JCA 1.5 ActivationSpec
	...
	public boolean isPubSubDomain() {
		...
		throw new IllegalStateException("Could not determine pubSubDomain - no activation spec com.mxk.config is set");
	}
	...
	public boolean isReplyPubSubDomain() {
		...
		throw new IllegalStateException("Could not determine reply pubSubDomain - no activation spec com.mxk.config is set");
	}
	...
	public QosSettings getReplyQosSettings() {
		...
		throw new IllegalStateException("Could not determine reply qosSettings - no activation spec com.mxk.config is set");
	}
}
