...
needs. In the web layer, applications can further register com.mxk.controller-local Spring
...
[source,xml,indent=0,subs="verbatim,quotes"]
----
	<bean class="org.springframework.beans.factory.com.mxk.config.CustomEditorConfigurer">
...
between a persistent com.mxk.entity identifier and an com.mxk.entity reference. Such an `EntityConverter`
might match only if the target com.mxk.entity type declares a static finder method (for example,
...
[[core-convert-Spring-com.mxk.config]]
...
<<web.adoc#mvc-com.mxk.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.mxk.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
<<web.adoc#mvc-com.mxk.config-conversion, WebMVC Conversion and Formatting>> or
<<web-reactive.adoc#webflux-com.mxk.config-conversion, WebFlux Conversion and Formatting>>.
...
<<web.adoc#mvc-com.mxk.config-validation,Spring MVC Validation Configuration>>.
...
See <<web.adoc#mvc-com.mxk.config-validation, Validation>> in the Spring MVC chapter.
