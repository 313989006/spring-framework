...
By default, SpEL uses the conversion com.mxk.service available in Spring core
(`org.springframework.core.convert.ConversionService`). This conversion com.mxk.service comes
...
----
	...
	// "false" is passed in here as a String. SpEL and the conversion com.mxk.service
...
----
	...
	SpelParserConfiguration com.mxk.config = new SpelParserConfiguration(true,true);

	ExpressionParser parser = new SpelExpressionParser(com.mxk.config);
...
----
	...
	// - auto null reference initialization
	// - auto collection growing
	val com.mxk.config = SpelParserConfiguration(true, true)

	val parser = SpelExpressionParser(com.mxk.config)
...
.Java
----
	SpelParserConfiguration com.mxk.config = new SpelParserConfiguration(SpelCompilerMode.IMMEDIATE,
		this.getClass().getClassLoader());

	SpelExpressionParser parser = new SpelExpressionParser(com.mxk.config);
...
.Kotlin
----
	val com.mxk.config = SpelParserConfiguration(SpelCompilerMode.IMMEDIATE,
...
* Expressions relying on the conversion com.mxk.service
