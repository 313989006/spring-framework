...
{api-spring-framework}/beans/factory/com.mxk.config/FieldRetrievingFactoryBean.html[`FieldRetrievingFactoryBean`]
...
{api-spring-framework}/beans/factory/com.mxk.config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)[`staticField`]
property:
...
----
	...
	<bean id="testBean.age" class="org.springframework.beans.factory.com.mxk.config.PropertyPathFactoryBean"/>
----
...
----
	...
	<bean id="theAge"
			class="org.springframework.beans.factory.com.mxk.config.PropertyPathFactoryBean">
...
----
	...
	<bean id="jdbcConfiguration" class="org.springframework.beans.factory.com.mxk.config.PropertiesFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.mxk.config.ListFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.mxk.config.MapFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.mxk.config.SetFactoryBean">
...
==== Using `<annotation-com.mxk.config/>`
...
* <<core.adoc#beans-annotation-com.mxk.config, `@Autowired`/`@Inject`>> and `@Value`
...
This element is detailed in the section on <<core.adoc#beans-annotation-com.mxk.config,
...
----
	...
	import org.springframework.beans.factory.com.mxk.config.BeanDefinition;
...
com.mxk.service object that (unknown to it) accesses a clustered
...
----
	...
	import org.springframework.beans.factory.com.mxk.config.BeanDefinitionHolder;
	import org.springframework.beans.factory.support.AbstractBeanDefinition;
	import org.springframework.beans.factory.support.BeanDefinitionBuilder;
