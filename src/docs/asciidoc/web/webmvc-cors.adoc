...
[[mvc-cors-com.mxk.controller]]
== `@CrossOrigin`
[.small]#<<web-reactive.adoc#webflux-cors-com.mxk.controller, WebFlux>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.mxk.controller methods,
...
* All origins.
* All headers.
* All HTTP methods to which the com.mxk.controller method is mapped.
...
In addition to fine-grained, com.mxk.controller method level configuration, you probably want to
...
To enable CORS in the MVC Java com.mxk.config, you can use the `CorsRegistry` callback,
as the following example shows:
...
.Java
----
	CorsConfiguration com.mxk.config = new CorsConfiguration();

	// Possibly...
	// com.mxk.config.applyPermitDefaultValues()

	com.mxk.config.setAllowCredentials(true);
	com.mxk.config.addAllowedOrigin("https://domain1.com");
	com.mxk.config.addAllowedHeader("*");
	com.mxk.config.addAllowedMethod("*");

	UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
	source.registerCorsConfiguration("/**", com.mxk.config);
...
.Kotlin
----
	val com.mxk.config = CorsConfiguration()

	// Possibly...
	// com.mxk.config.applyPermitDefaultValues()

	com.mxk.config.allowCredentials = true
	com.mxk.config.addAllowedOrigin("https://domain1.com")
	com.mxk.config.addAllowedHeader("*")
	com.mxk.config.addAllowedMethod("*")
