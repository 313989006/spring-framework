...
"most specific" com.mxk.controller method is picked automatically.
...
<<web-reactive.adoc#webflux-com.mxk.config>>, which uses Spring configuration to declare the
