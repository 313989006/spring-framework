...
[[webflux-cors-com.mxk.controller]]
== `@CrossOrigin`
[.small]#<<web.adoc#mvc-cors-com.mxk.controller, Web MVC>>#

The {api-spring-framework}/web/bind/annotation/CrossOrigin.html[`@CrossOrigin`]
annotation enables cross-origin requests on annotated com.mxk.controller methods, as the
...
----
	...
	fun corsFilter(): CorsWebFilter {
		...
		val source = UrlBasedCorsConfigurationSource().apply {
			registerCorsConfiguration("/**", com.mxk.config)
		}
