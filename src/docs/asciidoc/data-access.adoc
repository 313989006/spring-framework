...
interaction between the data access layer and the business or com.mxk.service layer.
...
This is primarily a com.mxk.service provider interface (SPI), although you can use it
...
The reactive transaction manager is primarily a com.mxk.service provider interface (SPI),
...
.Java
----
	// the com.mxk.service interface that we want to make transactional
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<!-- this is the com.mxk.service object that we want to make transactional -->
		<bean id="fooService" class="x.y.com.mxk.service.DefaultFooService"/>
		...
		<aop:com.mxk.config>
			<aop:pointcut id="fooServiceOperation" expression="execution(* x.y.com.mxk.service.FooService.*(..))"/>
...
Examine the preceding configuration. It assumes that you want to make a com.mxk.service object,
...
The `<aop:com.mxk.config/>` definition ensures that the transactional advice defined by the
...
A common requirement is to make an entire com.mxk.service layer transactional. The best way to
do this is to change the pointcut expression to match any operation in your
com.mxk.service layer. The following example shows how to do so:

[source,xml,indent=0,subs="verbatim"]
----
	<aop:com.mxk.config>
		<aop:pointcut id="fooServiceMethods" expression="execution(* x.y.com.mxk.service.*.*(..))"/>
		<aop:advisor advice-ref="txAdvice" pointcut-ref="fooServiceMethods"/>
	</aop:com.mxk.config>
----

NOTE: In the preceding example, it is assumed that all your com.mxk.service interfaces are defined
in the `x.y.com.mxk.service` package. See <<core.adoc#aop, the AOP section>> for more details.
...
----
	...
	[JdkDynamicAopProxy] - Creating JDK dynamic proxy for [x.y.com.mxk.service.DefaultFooService]

	<!-- ... the insertFoo(..) method is now being invoked on the proxy -->
	[TransactionInterceptor] - Getting transaction for x.y.com.mxk.service.FooService.insertFoo

	<!-- the transactional advice kicks in here... -->
	[DataSourceTransactionManager] - Creating new transaction with name [x.y.com.mxk.service.FooService.insertFoo]
	[DataSourceTransactionManager] - Acquired Connection [org.apache.commons.dbcp.PoolableConnection@a53de4] for JDBC transaction

	<!-- the insertFoo(..) method from DefaultFooService throws an exception... -->
	[RuleBasedTransactionAttribute] - Applying rules to determine whether transaction should rollback on java.lang.UnsupportedOperationException
	[TransactionInterceptor] - Invoking rollback for transaction on x.y.com.mxk.service.FooService.insertFoo due to throwable [java.lang.UnsupportedOperationException]
	...
	Exception in thread "main" java.lang.UnsupportedOperationException at x.y.com.mxk.service.DefaultFooService.insertFoo(DefaultFooService.java:14)
...
.Java
----
	// the reactive com.mxk.service interface that we want to make transactional
...
classes, typically com.mxk.service layer classes, declaratively in your application. This
...
Consider the scenario where you have a number of com.mxk.service layer objects, and you want to
...
As a point of comparison, first assume that all of your com.mxk.service layer classes are
defined in a root `x.y.com.mxk.service` package. To make all beans that are instances of classes
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.mxk.config>
			...
			<aop:pointcut id="serviceOperation"
					expression="execution(* x.y.com.mxk.service..*Service.*(..))"/>
		...
		<bean id="fooService" class="x.y.com.mxk.service.DefaultFooService"/>
		<bean id="barService" class="x.y.com.mxk.service.extras.SimpleBarService"/>

		<!-- ... and these two beans won't -->
		<bean id="anotherService" class="org.xyz.SomeService"/> <!-- (not in the right package) -->
		<bean id="barManager" class="x.y.com.mxk.service.SimpleBarManager"/> <!-- (doesn't end in 'Service') -->
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.mxk.config>
			...
			<aop:pointcut id="noTxServiceOperation"
					expression="execution(* x.y.com.mxk.service.ddl.DefaultDdlManager.*(..))"/>
		...
		<bean id="anotherFooService" class="x.y.com.mxk.service.ddl.DefaultDdlManager"/>
...
.Java
----
	// the com.mxk.service class that we want to make transactional
	@Transactional
	public class DefaultFooService implements FooService {
...
.Java
----
	// the reactive com.mxk.service class that we want to make transactional
	@Transactional
	public class DefaultFooService implements FooService {
...
within the same thread (for example, a com.mxk.service facade that delegates to several repository methods
where all the underlying resources have to participate in the com.mxk.service-level transaction).
...
the first case the bean is given to the com.mxk.service directly; in the second case it is given
...
more business com.mxk.service dependencies on the data access or transaction strategy, no more
hard-coded resource lookups, no more hard-to-replace singletons, no more custom com.mxk.service
...
You can annotate the com.mxk.service layer with `@Transactional` annotations and instruct the
...
exist on the implementation of the surrounding business com.mxk.service. It needs only a Spring
...
a transaction manager and a business com.mxk.service definition in a Spring application context
...
sources are transactional container ones, a business com.mxk.service can demarcate transactions
...
that is used by the application to obtain an com.mxk.entity manager.
...
annotated com.mxk.entity classes is supposed to occur. An explicit 'true' value
...
if you want com.mxk.entity class scanning to occur.
...
consider using the Spring `context:annotation-com.mxk.config` XML element in your application
...
----
	<beans>
		...
		<!-- post-processors for all standard com.mxk.config annotations -->
...
[[oxm-schema-based-com.mxk.config]]
