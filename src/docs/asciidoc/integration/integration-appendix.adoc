...
----
	<bean id="simple"
		...
		<property name="businessInterface" value="com.foo.com.mxk.service.RentalService"/>
	</bean>
----
...
----
	<jee:local-slsb id="simpleSlsb" jndi-name="ejb/RentalServiceBean"
			business-interface="com.foo.com.mxk.service.RentalService"/>
----
...
----
	<bean id="complexLocalEjb"
			class="org.springframework.ejb.access.LocalStatelessSessionProxyFactoryBean">
		<property name="jndiName" value="ejb/RentalServiceBean"/>
		<property name="businessInterface" value="com.example.com.mxk.service.RentalService"/>
...
----
	<bean id="complexRemoteEjb"
		...
		<property name="lookupHomeOnStartup" value="true"/>
		<property name="resourceRef" value="true"/>
		<property name="homeInterface" value="com.foo.com.mxk.service.RentalService"/>
...
----
	<jee:remote-slsb id="complexRemoteEjb"
			...
			lookup-home-on-startup="true"
			resource-ref="true"
			home-interface="com.foo.com.mxk.service.RentalService"
