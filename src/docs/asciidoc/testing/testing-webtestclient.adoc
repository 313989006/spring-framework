...
[[webtestclient-com.mxk.controller-com.mxk.config]]
=== Bind to Controller
...
The preceding example loads the <<web-reactive.adoc#webflux-com.mxk.config, WebFlux Java configuration>>
and registers the given com.mxk.controller. The resulting WebFlux application is tested
...
[[webtestclient-fn-com.mxk.config]]
...
[[webtestclient-context-com.mxk.config]]
...
[[webtestclient-server-com.mxk.config]]
=== Bind to Server
...
[[webtestclient-client-com.mxk.config]]
=== Client Builder
