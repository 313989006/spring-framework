...
the meaty business logic of an application being contained in the domain and com.mxk.service
...
----
	...
	import org.springframework.showcase.fortune.com.mxk.service.FortuneService
