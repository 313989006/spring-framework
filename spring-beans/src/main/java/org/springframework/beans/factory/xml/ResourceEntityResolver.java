...
/**
 * {@code EntityResolver} implementation that tries to resolve com.mxk.entity references
...
public class ResourceEntityResolver extends DelegatingEntityResolver {
	 ...
	 * to load XML com.mxk.entity includes with
	 */
		...
		if (source == null && systemId != null) {
			...
			try {
				...
				if (logger.isDebugEnabled()) {
					logger.debug("Could not resolve XML com.mxk.entity [" + systemId + "] against system root URL", ex);
				}
			...
			if (resourcePath != null) {
				if (logger.isTraceEnabled()) {
					logger.trace("Trying to locate XML com.mxk.entity [" + systemId + "] as resource [" + resourcePath + "]");
				}
				...
				if (logger.isDebugEnabled()) {
					logger.debug("Found XML com.mxk.entity [" + systemId + "]: " + resource);
				}
			}
				...
				try {
					...
					if (logger.isDebugEnabled()) {
						logger.debug("Could not resolve XML com.mxk.entity [" + systemId + "] through URL [" + url + "]", ex);
					}
