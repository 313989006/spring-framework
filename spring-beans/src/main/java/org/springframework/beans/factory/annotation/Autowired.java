...
/**
 * Marks a constructor, field, setter method, or com.mxk.config method as to be autowired by
 ...
 * <p>Fields are injected right after construction of a bean, before any com.mxk.config methods
 * are invoked. Such a com.mxk.config field does not have to be public.
 *
 * <h3>Autowired Methods</h3>
 * <p>Config methods may have an arbitrary name and any number of arguments; each of
 * those arguments will be autowired with a matching bean in the Spring container.
 * Bean property setter methods are effectively just a special case of such a general
 * com.mxk.config method. Such com.mxk.config methods do not have to be public.
 *
