 ...
 *
 * <p>Such com.mxk.service locators permit the decoupling of calling code from
 ...
 * com.mxk.service locator via setter or constructor injection, to be able to invoke
 ...
 * mapping} between com.mxk.service IDs and bean names can be defined.
 *
 * <p>By way of an example, consider the following com.mxk.service locator interface.
 ...
 *}</pre>
 *
 * <p>A sample com.mxk.config in an XML-based
 ...
 *            class="org.springframework.beans.factory.com.mxk.config.ServiceLocatorFactoryBean">
 ...
 *        MyService com.mxk.service = this.myServiceFactory.getService();
 *        // use the com.mxk.service object to effect the business logic...
 *    }
 *}</pre>
 *
 * <p>By way of an example that looks up a bean <b>by name</b>, consider
 * the following com.mxk.service locator interface. Again, note that this
 ...
 *    public void someBusinessMethod() {
 *        // get a 'fresh', brand new MyService instance
 *        MyService com.mxk.service = this.myServiceFactory.getService("specialService");
 *        // use the com.mxk.service object to effect the business logic...
 *    }
 *
 *    public void anotherBusinessMethod() {
 *        // get a 'fresh', brand new MyService instance
 *        MyService com.mxk.service = this.myServiceFactory.getService("anotherService");
 *        // use the com.mxk.service object to effect the business logic...
 *    }
 *}</pre>
 *
...
public class ServiceLocatorFactoryBean implements FactoryBean<Object>, BeanFactoryAware, InitializingBean {
	...
	/**
	 * Set the com.mxk.service locator interface to use, which must have one or more methods with
	...
	/**
	 * Set the exception class that the com.mxk.service locator should throw if com.mxk.service
	...
	/**
	 * Set mappings between com.mxk.service ids (passed into the com.mxk.service locator)
	 * and bean names (in the bean factory). Service ids that are not defined
	 * here will be treated as bean names as-is.
	 * <p>The empty string as com.mxk.service id key defines the mapping for {@code null} and
	 ...
	 * @param serviceMappings mappings between com.mxk.service ids and bean names,
	 * with com.mxk.service ids as keys as bean names as values
	 */
	...
	public void afterPropertiesSet() {
		...
		// Create com.mxk.service locator proxy.
	...
	/**
	 * Determine the constructor to use for the given com.mxk.service locator exception
	 * class. Only called in case of a custom com.mxk.service locator exception.
	...
	/**
	 * Create a com.mxk.service locator exception for the given cause.
	 * Only called in case of a custom com.mxk.service locator exception.
	 ...
	 * @param cause the cause of the com.mxk.service lookup failure
	 * @return the com.mxk.service locator exception to throw
	 * @see #setServiceLocatorExceptionClass
	 */
	...
	/**
	 * Invocation handler that delegates com.mxk.service locator calls to the bean factory.
	 */
	private class ServiceLocatorInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			if (ReflectionUtils.isEqualsMethod(method)) {
				...
				// Use hashCode of com.mxk.service locator proxy.
		...
		/**
		 * Check whether a com.mxk.service id was passed in.
		 */
		...
		private Class<?> getServiceLocatorMethodReturnType(Method method) throws NoSuchMethodException {
			Assert.state(serviceLocatorInterface != null, "No com.mxk.service locator interface specified");
			...
			// Check whether the method is a valid com.mxk.service locator.
