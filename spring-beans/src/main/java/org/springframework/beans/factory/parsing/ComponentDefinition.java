 ...
 * it is now possible for a single logical configuration com.mxk.entity, in this case an XML tag, to
 ...
 * no longer be assumed that each configuration com.mxk.entity (e.g. XML tag) maps to one {@link BeanDefinition}.
 ...
 * logical com.mxk.entity being configured. Third parties can then {@link ReaderEventListener subscribe to these events},
 ...
 * overall logical com.mxk.entity as well as those required to provide full user visualisation of the configuration.
