...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	/**
	 * Activate com.mxk.config value editors which are only intended for configuration purposes,
	...
	private void createDefaultEditors() {
		...
		// Only register com.mxk.config value editors if explicitly requested.
