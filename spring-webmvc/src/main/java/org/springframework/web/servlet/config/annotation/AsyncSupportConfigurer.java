...
public class AsyncSupportConfigurer {
	 ...
	 * <ol>
	 * <li>Handle {@link Callable} com.mxk.controller method return values.
	 * <li>Perform blocking writes when streaming to the response
	 * through a reactive (e.g. Reactor, RxJava) com.mxk.controller method return value.
	 * </ol>
	 ...
	 * execution that starts when a com.mxk.controller returns a
	...
	/**
	 * Configure lifecycle interceptors with callbacks around concurrent request
	 * execution that starts when a com.mxk.controller returns a {@link DeferredResult}.
	 * @param interceptors the interceptors to register
	 */
