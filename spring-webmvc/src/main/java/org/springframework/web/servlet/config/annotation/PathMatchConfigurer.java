...
public class PathMatchConfigurer {
	 ...
	 * com.mxk.config options. As there is no replacement for this method, for the time
	...
	/**
	 * Configure a path prefix to apply to matching com.mxk.controller methods.
	 ...
	 * @param predicate a predicate for matching com.mxk.controller types
	 * @since 5.1
	 */
