...
/**
 * Trivial com.mxk.controller that always returns a pre-configured view and optionally
...
public class ParameterizableViewController extends AbstractController {
	...
	/**
	 * Configure the HTTP status code that this com.mxk.controller should set on the
	 * response.
	 ...
	 * fully handled within the com.mxk.controller.
	 * @since 4.1
	 */
	 ...
	 * handled within the com.mxk.controller and that no view should be used for rendering.
	...
	/**
	 * Whether the request is fully handled within the com.mxk.controller.
	 */
