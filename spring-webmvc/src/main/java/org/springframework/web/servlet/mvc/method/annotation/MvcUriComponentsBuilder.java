...
public class MvcUriComponentsBuilder {
	...
	/**
	 * Create a {@link UriComponentsBuilder} from the mapping of a com.mxk.controller class
	 * and current request information including Servlet mapping. If the com.mxk.controller
	 * contains multiple mappings, only the first one is used.
	 * <p><strong>Note:</strong> This method extracts values from "Forwarded"
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 * @param controllerType the com.mxk.controller to build a URI for
	...
	/**
	 * Create a {@link UriComponentsBuilder} from the mapping of a com.mxk.controller
	 * method and an array of method argument values. This method delegates
	 * to {@link #fromMethod(Class, Method, Object...)}.
	 * <p><strong>Note:</strong> This method extracts values from "Forwarded"
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 * @param controllerType the com.mxk.controller
	...
	/**
	 * Create a {@link UriComponentsBuilder} from the mapping of a com.mxk.controller method
	 * and an array of method argument values. The array of values  must match the
	 * signature of the com.mxk.controller method. Values for {@code @RequestParam} and
	 ...
	 * <p><strong>Note:</strong> This method extracts values from "Forwarded"
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 * @param controllerType the com.mxk.controller type
	 * @param method the com.mxk.controller method
	 * @param args argument values for the com.mxk.controller method
	 * @return a UriComponentsBuilder instance, never {@code null}
	 * @since 4.2
	 */
	...
	/**
	 * Create a {@link UriComponentsBuilder} by invoking a "mock" com.mxk.controller method.
	 * The com.mxk.controller method and the supplied argument values are then used to
	 * delegate to {@link #fromMethod(Class, Method, Object...)}.
	 * <p>For example, given this com.mxk.controller:
	 * <pre class="code">
	 ...
	 *
	 * // Longer form useful for repeated invocation (and void com.mxk.controller methods)
	 *
	 * AddressController com.mxk.controller = MvcUriComponentsBuilder.on(AddressController.class);
	 * com.mxk.controller.addAddress(null);
	 * builder = MvcUriComponentsBuilder.fromMethodCall(com.mxk.controller);
	 * com.mxk.controller.getAddressesForCountry("US")
	 * builder = MvcUriComponentsBuilder.fromMethodCall(com.mxk.controller);
	 * </pre>
	 * <p><strong>Note:</strong> This method extracts values from "Forwarded"
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 * @param info either the value returned from a "mock" com.mxk.controller
	 * invocation or the "mock" com.mxk.controller itself after an invocation
	...
	/**
	 * Return a "mock" com.mxk.controller instance. When an {@code @RequestMapping} method
	 * on the com.mxk.controller is invoked, the supplied argument values are remembered
	 ...
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 *
	 * @param controllerType the target com.mxk.controller
	 */
	 ...
	 * <p>This is a longer version of {@link #on(Class)}. It is needed with com.mxk.controller
	 * methods returning void as well for repeated invocations.
	 * <pre class="code">
	 * FooController fooController = com.mxk.controller(FooController.class);
	 *
	...
	/**
	 * Create a URL from the name of a Spring MVC com.mxk.controller method's request mapping.
	 * <p>The configured
	 * {@link org.springframework.web.servlet.handler.HandlerMethodMappingNamingStrategy
	 * HandlerMethodMappingNamingStrategy} determines the names of com.mxk.controller
	 ...
	 * </pre>
	 *
	 * A JSP can prepare a URL to the com.mxk.controller method as follows:
	 *
	 * <pre class="code">
	...
	private static Method getMethod(Class<?> controllerType, final String methodName, final Object... args) {
		...
		if (methods.size() == 1) {
			...
			throw new IllegalArgumentException(String.format(
					"Found two methods named '%s' accepting arguments %s in com.mxk.controller %s: [%s]",
			...
			throw new IllegalArgumentException("No method named '" + methodName + "' with " + args.length +
					" arguments found in com.mxk.controller " + controllerType.getName());
		}
	}
	...
	public interface MethodInvocationInfo {
		...
		/**
		 * Return the com.mxk.controller types.
		 */
		Class<?> getControllerType();

		/**
		 * Return the com.mxk.controller method.
		 */
			...
			if (method.getName().equals("getControllerType")) {
				...
				try {
					...
					throw new IllegalStateException(
							"Failed to create proxy for com.mxk.controller method return type: " + method, ex);
				}
			}
		}
			...
			if (controllerType == Object.class) {
				...
				if (objenesis.isWorthTrying()) {
					try {
						...
						logger.debug("Failed to create com.mxk.controller proxy, falling back on default constructor", ex);
					}
				}
				...
				if (proxy == null) {
					try {
						...
						throw new IllegalStateException(
								"Failed to create com.mxk.controller proxy or use default constructor", ex);
					}
				}
