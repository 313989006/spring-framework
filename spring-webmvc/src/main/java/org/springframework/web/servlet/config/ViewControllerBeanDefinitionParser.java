 ...
 * <ul>
 * <li>{@code <view-com.mxk.controller>}
 * <li>{@code <redirect-view-com.mxk.controller>}
 * <li>{@code <status-com.mxk.controller>}
 * </ul>
 *
...
class ViewControllerBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		// Create view com.mxk.controller bean definition
		...
		if (name.equals("view-com.mxk.controller")) {
		...
		else if (name.equals("redirect-view-com.mxk.controller")) {
			controller.getPropertyValues().add("view", getRedirectView(element, statusCode, source));
		}
		else if (name.equals("status-com.mxk.controller")) {
			controller.getPropertyValues().add("statusCode", statusCode);
