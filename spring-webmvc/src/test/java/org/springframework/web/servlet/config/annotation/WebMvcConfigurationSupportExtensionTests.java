...
public class WebMvcConfigurationSupportExtensionTests {
	...
	public void setUp() {
		...
		this.context.registerSingleton("com.mxk.controller", TestController.class);
	 ...
	 * that ensures that application com.mxk.config classes that use the combo {@code @EnableWebMvc}
