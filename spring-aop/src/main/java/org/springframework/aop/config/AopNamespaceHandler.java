 ...
 * {@code <aop:com.mxk.config>} tag. A {@code com.mxk.config} tag can include nested
...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	 ...
	 * '{@code com.mxk.config}', '{@code spring-configured}', '{@code aspectj-autoproxy}'
	 * and '{@code scoped-proxy}' tags.
	 */
	@Override
	public void init() {
		// In 2.0 XSD as well as in 2.5+ XSDs
		registerBeanDefinitionParser("com.mxk.config", new ConfigBeanDefinitionParser());
