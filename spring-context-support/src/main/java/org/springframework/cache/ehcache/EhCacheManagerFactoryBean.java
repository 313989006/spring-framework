 ...
 * instance (independent or shared), configured from a specified com.mxk.config location.
 *
 * <p>If no com.mxk.config location is specified, a CacheManager will be configured from
 ...
 * also necessary for loading EhCache configuration from a non-default com.mxk.config location.
 *
...
public class EhCacheManagerFactoryBean implements FactoryBean<CacheManager>, InitializingBean, DisposableBean {
	...
	/**
	 * Set the location of the EhCache com.mxk.config file. A typical value is "/WEB-INF/ehcache.xml".
