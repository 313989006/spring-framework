...
public class FreeMarkerConfigurationFactory {
	...
	/**
	 * Set the location of the FreeMarker com.mxk.config file.
	 ...
	 * @throws IOException if the com.mxk.config file wasn't found
	...
	public Configuration createConfiguration() throws IOException, TemplateException {
		...
		// Load com.mxk.config file if specified.
	 ...
	 * @throws IOException if a com.mxk.config file wasn't found
	 * @throws TemplateException on FreeMarker initialization failure
	 * @see #createConfiguration()
	 */
