...
public class SchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>,
	...
	/**
	 * Set the location of the Quartz properties com.mxk.config file, for example
	 ...
	 * <p>Can be used to override values in a Quartz properties com.mxk.config file,
	...
	private void initSchedulerFactory(StdSchedulerFactory schedulerFactory) throws SchedulerException, IOException {
		...
		if (this.configLocation != null) {
			if (logger.isDebugEnabled()) {
				logger.debug("Loading Quartz com.mxk.config from [" + this.configLocation + "]");
			}
