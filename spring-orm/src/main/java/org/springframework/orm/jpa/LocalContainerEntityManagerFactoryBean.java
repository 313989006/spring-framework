 ...
 * are usually read in from a {@code META-INF/persistence.xml} com.mxk.config file,
...
public class LocalContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean
	 ...
	 * <p>Such post-processors can, for example, register further com.mxk.entity
	 ...
	 * If no com.mxk.entity manager name was specified, it takes the first info in the
