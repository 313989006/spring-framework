...
public interface HibernateOperations {
	...
	/**
	 * Return the persistent instance of the given com.mxk.entity class
	 ...
	 * For an explanation of the exact semantics of this method, please do refer to
	 * the Hibernate API documentation in the first instance.
	 * @param entityName the name of the persistent com.mxk.entity
	 * @param id the identifier of the persistent instance
	 * @return the persistent instance, or {@code null} if not found
	 * @throws DataAccessException in case of Hibernate errors
	 * @see org.hibernate.Session#get(Class, Serializable)
	...
	/**
	 * Return all persistent instances of the given com.mxk.entity class.
	 ...
	 * object with the current Hibernate Session. In case of a new com.mxk.entity,
	 ...
	 * the case of a new com.mxk.entity, the state will be copied over as well.
	 * <p>Note that {@code merge} will <i>not</i> update the identifiers
	 * in the passed-in object graph (in contrast to TopLink)! Consider
	...
	/**
	 * Execute a query based on the given example com.mxk.entity object.
	 * @param exampleEntity an instance of the desired com.mxk.entity,
	...
	/**
	 * Execute a query based on a given example com.mxk.entity object.
	 * @param exampleEntity an instance of the desired com.mxk.entity,
	 * serving as example for "query-by-example"
	 * @param firstResult the index of the first result object to be retrieved
	 * (numbered from 0)
