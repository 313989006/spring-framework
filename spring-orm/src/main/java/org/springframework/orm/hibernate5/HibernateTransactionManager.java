 ...
 * not to the Hibernate Session and its cached com.mxk.entity objects and related context.
...
public class HibernateTransactionManager extends AbstractPlatformTransactionManager
	...
	/**
	 * Set the bean name of a Hibernate com.mxk.entity interceptor that allows to inspect
	 ...
	 * @param entityInterceptorBeanName the name of the com.mxk.entity interceptor in
	 * the bean factory
	 * @see #setBeanFactory
	...
	/**
	 * Return the current Hibernate com.mxk.entity interceptor, or {@code null} if none.
	 * Resolves an com.mxk.entity interceptor bean name via the bean factory,
	 * if necessary.
	...
	public Interceptor getEntityInterceptor() throws IllegalStateException, BeansException {
		if (this.entityInterceptor instanceof Interceptor) {
			...
			if (this.beanFactory == null) {
				throw new IllegalStateException("Cannot get com.mxk.entity interceptor via bean name if no bean factory set");
			}
	...
	/**
	 * The bean factory just needs to be known for resolving com.mxk.entity interceptor
	...
	protected void doBegin(Object transaction, TransactionDefinition definition) {
		...
		try {
			...
			if (definition.isReadOnly() && txObject.isNewSession()) {
				...
				// As of 5.1, we're also setting Hibernate's read-only com.mxk.entity mode by default.
	 ...
	 * returning its database connection but preserving its com.mxk.entity state.
