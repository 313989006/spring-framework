...
public class HttpComponentsClientHttpRequestFactory implements ClientHttpRequestFactory, DisposableBean {
	 ...
	 * Can return {@code null} to indicate that no custom request com.mxk.config should
	 ...
	 * @param clientConfig the com.mxk.config held by the current
	 * @return the merged request com.mxk.config
	 * @since 4.2
	 */
	 ...
	 * exchange methods which allow the combination of HTTP DELETE with an com.mxk.entity.
	 * @since 4.1.2
	 */
