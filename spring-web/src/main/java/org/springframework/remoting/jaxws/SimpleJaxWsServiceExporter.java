 ...
 * for each com.mxk.service will consist of the base address with the com.mxk.service name
...
public class SimpleJaxWsServiceExporter extends AbstractJaxWsServiceExporter {
	 ...
	 * <p>For each actual publication address, the com.mxk.service name will be
