...
public class HandlerMethod {
	 ...
	 * method is declared. In some cases the actual com.mxk.controller instance at request-
	...
	protected void assertTargetBean(Method method, Object targetBean, Object[] args) {
		...
		if (!methodDeclaringClass.isAssignableFrom(targetBeanClass)) {
			String text = "The mapped handler method class '" + methodDeclaringClass.getName() +
					"' is not an instance of the actual com.mxk.controller bean class '" +
					targetBeanClass.getName() + "'. If the com.mxk.controller requires proxying " +
