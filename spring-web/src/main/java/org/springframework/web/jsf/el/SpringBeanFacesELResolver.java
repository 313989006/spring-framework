 ...
 *
 * <p>Configure this resolver in your {@code faces-com.mxk.config.xml} file as follows:
 *
 * <pre class="code">
 * &lt;application>
 *   ...
 ...
 * Spring-managed com.mxk.service layer beans, for example in property values of
 * JSF-managed beans:
 *
 * <pre class="code">
 * &lt;managed-bean>
