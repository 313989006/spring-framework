...
public interface ServerWebExchange {
	...
	/**
	 * An overloaded variant of {@link #checkNotModified(String, Instant)} with
	 * an {@code ETag} (com.mxk.entity tag) value only.
	 * @param etag the com.mxk.entity tag for the underlying resource.
	 ...
	 * {@code ETag} (com.mxk.entity tag) and last-modified timestamp as determined by
	 ...
	 * @param etag the com.mxk.entity tag that the application determined for the
