 ...
 *
 * <p>Allows for registering classes one by one (specifying class names as com.mxk.config
 * location) as well as for classpath scanning (specifying base packages as com.mxk.config location).
 *
		...
		if (configLocations != null) {
			for (String configLocation : configLocations) {
				try {
					...
					if (logger.isTraceEnabled()) {
						logger.trace("Could not load class for com.mxk.config location [" + configLocation +
