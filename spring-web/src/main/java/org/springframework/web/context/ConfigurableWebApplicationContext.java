...
public interface ConfigurableWebApplicationContext extends WebApplicationContext, ConfigurableApplicationContext {
	 ...
	 * to be used for building a default context com.mxk.config location.
	...
	/**
	 * Set the com.mxk.config locations for this web application context in init-param style,
	...
	/**
	 * Set the com.mxk.config locations for this web application context.
	 * <p>If not set, the implementation is supposed to use a default for the
	 * given namespace or the root web application context, as appropriate.
	 */
	...
	/**
	 * Return the com.mxk.config locations for this web application context,
