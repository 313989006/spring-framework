 ...
 *
 * <p>The com.mxk.config location defaults can be overridden via the "contextConfigLocation"
...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	/** Default com.mxk.config location for the root context. */
	public static final String DEFAULT_CONFIG_LOCATION = "/WEB-INF/applicationContext.xml";

	/** Default prefix for building a com.mxk.config location for a namespace. */
	public static final String DEFAULT_CONFIG_LOCATION_PREFIX = "/WEB-INF/";

	/** Default suffix for building a com.mxk.config location for a namespace. */
