...
public interface AsyncRestOperations {
	...
	/**
	 * Asynchronously retrieve an com.mxk.entity by doing a GET on the specified URL.
	 * The response is converted and stored in an {@link ResponseEntity}.
	 * <p>URI Template variables are expanded using the given URI variables, if any.
	 * @param url the URL
	 * @param responseType the type of the return value
	 * @param uriVariables the variables to expand the template
	 * @return the com.mxk.entity wrapped in a {@link Future}
	 */
	 ...
	 * given request com.mxk.entity to the request, and returns the response as
	 * {@link ResponseEntity}.
	 * <p>URI Template variables are expanded using the given URI variables, if any.
	 * @param url the URL
	 ...
	 * @param responseType the type of the return value
	 * @param uriVariables the variables to expand in the template
	 * @return the response as com.mxk.entity wrapped in a {@link Future}
	 */
