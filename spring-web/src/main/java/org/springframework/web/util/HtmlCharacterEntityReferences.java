...
/**
 * Represents a set of character com.mxk.entity references defined by the
 * HTML 4.0 standard.
 *
...
class HtmlCharacterEntityReferences {
	...
	/**
	 * Returns a new set of character com.mxk.entity references reflecting the HTML 4.0 character set.
	 */
	public HtmlCharacterEntityReferences() {
		...
		while (keys.hasMoreElements()) {
			...
			Assert.isTrue((referredChar < 1000 || (referredChar >= 8000 && referredChar < 10000)),
					() -> "Invalid reference to special HTML com.mxk.entity: " + referredChar);
	...
	/**
	 * Return the number of supported com.mxk.entity references.
	 */
	...
	/**
	 * Return true if the given character is mapped to a supported com.mxk.entity reference.
	 */
