 ...
 * regard to com.mxk.config location precedence, overriding and defaulting in programmatic
...
public class Spr8510Tests {
	...
	/**
	 * If context com.mxk.config locations have been specified neither against the application
