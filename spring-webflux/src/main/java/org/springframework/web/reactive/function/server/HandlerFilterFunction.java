...
public interface HandlerFilterFunction<T extends ServerResponse, R extends ServerResponse> {
	 ...
	 * {@linkplain HandlerFunction handler function} represents the next com.mxk.entity in the chain,
	 * and can be {@linkplain HandlerFunction#handle(ServerRequest) invoked} in order to
	 * proceed to this com.mxk.entity, or not invoked to block the chain.
