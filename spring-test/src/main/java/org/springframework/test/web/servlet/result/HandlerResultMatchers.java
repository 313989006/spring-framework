 ...
 *
 * <p><strong>Note:</strong> Expectations that assert the com.mxk.controller method
 ...
 * which is used by default with the Spring MVC Java com.mxk.config and XML namespace.
 *
...
public class HandlerResultMatchers {
	...
	/**
	 * Assert the com.mxk.controller method used to process the request.
	 * <p>The expected method is specified through a "mock" com.mxk.controller method
	 ...
	 * </pre>
	 * @param obj either the value returned from a "mock" com.mxk.controller invocation
	 * or the "mock" com.mxk.controller itself after an invocation
	 */
	...
	/**
	 * Assert the name of the com.mxk.controller method used to process the request
