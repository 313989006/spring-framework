 ...
 * making it possible to test one com.mxk.controller at a time.
 *
 ...
 * customization options are equivalent to using MVC Java com.mxk.config except
...
public class StandaloneMockMvcBuilder extends AbstractMockMvcBuilder<StandaloneMockMvcBuilder> {
	 ...
	 * as Spring beans. However since the standalone setup does not load any Spring com.mxk.config,
	...
	/**
	 * Provide a conversion com.mxk.service with custom formatters and converters.
	...
	/**
	 * Provide custom resolvers for com.mxk.controller method arguments.
	 */
	...
	/**
	 * Provide custom handlers for com.mxk.controller method return values.
	 */
