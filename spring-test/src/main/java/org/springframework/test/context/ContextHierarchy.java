 ...
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/soap-ws-com.mxk.config.xml"))
 * public class SoapWebServiceTests extends AbstractWebTests {}
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/rest-ws-com.mxk.config.xml"))
 ...
 * three application contexts will be loaded: one for {@code "/app-com.mxk.config.xml"},
 * one for {@code "/user-com.mxk.config.xml"}, and one for <code>{"/user-com.mxk.config.xml",
 * "/order-com.mxk.config.xml"}</code>. As with the previous example, the application
 * context loaded from {@code "/app-com.mxk.config.xml"} will be set as the parent context
 * for the contexts loaded from {@code "/user-com.mxk.config.xml"} and <code>{"/user-com.mxk.config.xml",
 * "/order-com.mxk.config.xml"}</code>.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 *     &#064;ContextConfiguration(name = "parent", locations = "/app-com.mxk.config.xml"),
 *     &#064;ContextConfiguration(name = "child",  locations = "/user-com.mxk.config.xml")
 * })
 * public class BaseTests {}
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/order-com.mxk.config.xml")
 * )
 ...
 * only from {@code "/test-user-com.mxk.config.xml"} and will have its parent set to the
 * context loaded from {@code "/app-com.mxk.config.xml"}.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 ...
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/test-user-com.mxk.config.xml", inheritLocations = false)
 * )
 * public class ExtendedTests extends BaseTests {}</pre>
 *
