...
public class RequestContextHolderTests {
	...
	public void requestScopedController() throws Exception {
		assertThat(AopUtils.isCglibProxy(this.requestScopedController)).as("request-scoped com.mxk.controller must be a CGLIB proxy").isTrue();
	...
	public void requestScopedService() throws Exception {
		assertThat(AopUtils.isCglibProxy(this.requestScopedService)).as("request-scoped com.mxk.service must be a CGLIB proxy").isTrue();
	...
	public void sessionScopedService() throws Exception {
		assertThat(AopUtils.isCglibProxy(this.sessionScopedService)).as("session-scoped com.mxk.service must be a CGLIB proxy").isTrue();
