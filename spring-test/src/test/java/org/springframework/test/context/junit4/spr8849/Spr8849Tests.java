 ...
 * for the embedded database (see {@code datasource-com.mxk.config.xml}), we ensure
 ...
 * {@code datasource-com.mxk.config.xml} and run this <em>suite</em>.
 *
 * <h3>Solution</h3>
 * <p>As of Spring 4.2, a proper solution is possible thanks to SPR-8849.
 * {@link TestClass3} and {@link TestClass4} both import
 * {@code datasource-com.mxk.config-with-auto-generated-db-name.xml} which makes
