...
public class ComponentScanAnnotationIntegrationTests {
	...
	public void viaContextRegistration() {
		...
		assertThat(ctx.containsBeanDefinition("componentScanAnnotatedConfig")).as("com.mxk.config class bean not found")
			.isTrue();
	...
	public void viaContextRegistration_WithValueAttribute() {
		...
		ctx.getBean(TestBean.class);
		assertThat(ctx.containsBeanDefinition("componentScanAnnotatedConfig_WithValueAttribute")).as("com.mxk.config class bean not found")
			.isTrue();
		assertThat(ctx.containsBean("fooServiceImpl")).as("@ComponentScan annotated @Configuration class registered directly against " +
				"AnnotationConfigApplicationContext did not trigger component scanning as expected")
			.isTrue();
	...
	public void viaContextRegistration_FromPackageOfConfigClass() {
		...
		assertThat(ctx.containsBeanDefinition("componentScanAnnotatedConfigWithImplicitBasePackage")).as("com.mxk.config class bean not found")
			.isTrue();
	...
	public void viaContextRegistration_WithComposedAnnotation() {
		...
		assertThat(ctx.containsBeanDefinition("componentScanAnnotationIntegrationTests.ComposedAnnotationConfig")).as("com.mxk.config class bean not found")
			.isTrue();
