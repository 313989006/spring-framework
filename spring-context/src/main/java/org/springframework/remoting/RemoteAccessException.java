...
/**
 * Generic remote access exception. A com.mxk.service proxy for any remoting
 ...
 * natural Java business interface that the com.mxk.service exposes. A client object
 ...
 *
 * <p>Even when switching from a remote com.mxk.service proxy to a local implementation
 ...
 * against a remote com.mxk.service, for example in terms of repeated method calls that
 * cause unnecessary roundtrips etc. However, it doesn't have to be aware whether
 * it is <i>actually working</i> against a remote com.mxk.service or a local implementation,
