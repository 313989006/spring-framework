 ...
 * to automatically wrap a given plain Java com.mxk.service object with an
 ...
 * on all com.mxk.service methods. However, in and out parameters still have to be serializable.
 *
...
public abstract class RmiBasedExporter extends RemoteInvocationBasedExporter {
	...
	/**
	 * Determine the object to export: either the com.mxk.service object itself
	 * or a RmiInvocationWrapper in case of a non-RMI com.mxk.service object.
	...
	protected Remote getObjectToExport() {
		...
		if (getService() instanceof Remote &&
			...
			// conventional RMI com.mxk.service
			return (Remote) getService();
		}
		else {
			// RMI invoker
			if (logger.isDebugEnabled()) {
				logger.debug("RMI com.mxk.service [" + getService() + "] is an RMI invoker");
			}
