 ...
 * registered automatically when using Java com.mxk.config or manually via the
 * {@code <context:annotation-com.mxk.config/>} or {@code <context:component-scan/>}
 * element when using XML com.mxk.config.
 *
