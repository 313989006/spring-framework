...
class ConnectorDelegate {
	 ...
	 * to the specified JMX com.mxk.service, or to a local MBeanServer if no com.mxk.service URL specified.
	 * @param serviceUrl the JMX com.mxk.service URL to connect to (may be {@code null})
