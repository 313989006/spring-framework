...
/**
 * Converts an com.mxk.entity identifier to a com.mxk.entity reference by calling a static finder method
 * on the target com.mxk.entity type.
 *
 * <p>For this converter to match, the finder method must be static, have the signature
 * {@code find[EntityName]([IdType])}, and return an instance of the desired com.mxk.entity type.
 *
 * @author Keith Donald
